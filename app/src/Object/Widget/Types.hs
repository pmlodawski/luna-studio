...
type DisplayObjectCtx a = (Show a, MouseMovable a, Typeable a, HasObjectId a)
...
class MouseMovable a where
    onMouseMove :: Vector2 Int -> a -> WidgetUpdate
