...
class ASTPtr : public ::google::protobuf::Message {
 public:
  ASTPtr();
  virtual ~ASTPtr();

  ASTPtr(const ASTPtr& from);

  inline ASTPtr& operator=(const ASTPtr& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ASTPtr& default_instance();

  void Swap(ASTPtr* other);
  ...
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ASTPtr& from);
  void MergeFrom(const ASTPtr& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_breadcrumbs() const;
  inline void clear_breadcrumbs();
  static const int kBreadcrumbsFieldNumber = 1;
  inline const ::generated::proto::crumb::Breadcrumbs& breadcrumbs() const;
  inline ::generated::proto::crumb::Breadcrumbs* mutable_breadcrumbs();
  inline ::generated::proto::crumb::Breadcrumbs* release_breadcrumbs();
  inline void set_allocated_breadcrumbs(::generated::proto::crumb::Breadcrumbs* breadcrumbs);
  ...
  // @@protoc_insertion_point(class_scope:generated.proto.crumb.ASTPtr)
 private:
  inline void set_has_breadcrumbs();
  inline void clear_has_breadcrumbs();
  inline void set_has_libraryid();
  inline void clear_has_libraryid();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::generated::proto::crumb::Breadcrumbs* breadcrumbs_;
  ...
  void InitAsDefaultInstance();
  static ASTPtr* default_instance_;
};
// ===================================================================
...
inline void Crumb::set_cls(::generated::proto::crumb::Crumb_Cls value) {
  assert(::generated::proto::crumb::Crumb_Cls_IsValid(value));
  set_has_cls();
  cls_ = value;
}
...
inline void Crumb::set_allocated_name(::std::string* name) {
  if (name_ != &::google::protobuf::internal::kEmptyString) {
    delete name_;
  }
  if (name) {
...
// repeated string path = 3;
inline int Crumb::path_size() const {
  return path_.size();
}
inline void Crumb::clear_path() {
  path_.Clear();
}
inline const ::std::string& Crumb::path(int index) const {
  return path_.Get(index);
}
inline ::std::string* Crumb::mutable_path(int index) {
  return path_.Mutable(index);
}
inline void Crumb::set_path(int index, const ::std::string& value) {
  path_.Mutable(index)->assign(value);
}
inline void Crumb::set_path(int index, const char* value) {
  path_.Mutable(index)->assign(value);
}
inline void Crumb::set_path(int index, const char* value, size_t size) {
  path_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
}
inline ::std::string* Crumb::add_path() {
  return path_.Add();
}
inline void Crumb::add_path(const ::std::string& value) {
  path_.Add()->assign(value);
}
inline void Crumb::add_path(const char* value) {
  path_.Add()->assign(value);
}
inline void Crumb::add_path(const char* value, size_t size) {
...
// optional .generated.proto.crumb.Breadcrumbs breadcrumbs = 1;
inline bool ASTPtr::has_breadcrumbs() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ASTPtr::set_has_breadcrumbs() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ASTPtr::clear_has_breadcrumbs() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ASTPtr::clear_breadcrumbs() {
  if (breadcrumbs_ != NULL) breadcrumbs_->::generated::proto::crumb::Breadcrumbs::Clear();
  clear_has_breadcrumbs();
}
inline const ::generated::proto::crumb::Breadcrumbs& ASTPtr::breadcrumbs() const {
  return breadcrumbs_ != NULL ? *breadcrumbs_ : *default_instance_->breadcrumbs_;
}
inline ::generated::proto::crumb::Breadcrumbs* ASTPtr::mutable_breadcrumbs() {
  set_has_breadcrumbs();
  if (breadcrumbs_ == NULL) breadcrumbs_ = new ::generated::proto::crumb::Breadcrumbs;
  return breadcrumbs_;
}
inline ::generated::proto::crumb::Breadcrumbs* ASTPtr::release_breadcrumbs() {
  clear_has_breadcrumbs();
  ::generated::proto::crumb::Breadcrumbs* temp = breadcrumbs_;
  breadcrumbs_ = NULL;
  return temp;
}
inline void ASTPtr::set_allocated_breadcrumbs(::generated::proto::crumb::Breadcrumbs* breadcrumbs) {
  delete breadcrumbs_;
...
// optional int32 libraryID = 2;
inline bool ASTPtr::has_libraryid() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ASTPtr::set_has_libraryid() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ASTPtr::clear_has_libraryid() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ASTPtr::clear_libraryid() {
  libraryid_ = 0;
  clear_has_libraryid();
}
inline ::google::protobuf::int32 ASTPtr::libraryid() const {
  return libraryid_;
}
inline void ASTPtr::set_libraryid(::google::protobuf::int32 value) {
  set_has_libraryid();
  libraryid_ = value;
}
