...
void protobuf_AssignDesc_graph_2eproto() {
  ...
  static const int Node_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Node, expr_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Node, outputname_),
  };
  Node_reflection_ =
...
void protobuf_AddDesc_graph_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013graph.proto\022\025generated.proto.graph\"\222\001\n"
    "\004Node\022,\n\003cls\030\001 \002(\0162\037.generated.proto.gra"
    "ph.Node.Cls\022\016\n\002id\030\002 \001(\005:\002-1\022\014\n\004expr\030\003 \001("
    "\t\022\024\n\noutputName\030\005 \001(\t:\000\"(\n\003Cls\022\010\n\004Expr\020\001"
    "\022\n\n\006Inputs\020\002\022\013\n\007Outputs\020\003\"J\n\004Edge\022\017\n\007nod"
    "eSrc\030\001 \001(\005\022\017\n\007nodeDst\030\002 \001(\005\022\017\n\007portSrc\030\003"
    " \001(\005\022\017\n\007portDst\030\004 \001(\005\"_\n\005Graph\022*\n\005nodes\030"
    "\001 \003(\0132\033.generated.proto.graph.Node\022*\n\005ed"
    "ges\030\002 \003(\0132\033.generated.proto.graph.Edge", 358);
...
const int Node::kExprFieldNumber;
const int Node::kOutputNameFieldNumber;
#endif  // !_MSC_VER
...
const Node& Node::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_graph_2eproto();
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(42)) goto parse_outputName;
        break;
      }
      ...
      case 5: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_outputName:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_outputname()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->outputname().data(), this->outputname().length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
...
void Node::MergeFrom(const Node& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_outputname()) {
      set_outputname(from.outputname());
    }
  }
...
void Node::Swap(Node* other) {
  if (other != this) {
    ...
    std::swap(outputname_, other->outputname_);
