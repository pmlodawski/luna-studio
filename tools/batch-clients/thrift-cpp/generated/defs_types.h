...
class DefManager {
 public:
  ...
  static const char* ascii_fingerprint; // = "2B6214A6CE43AC527AC7EE13800AC885";
  static const uint8_t binary_fingerprint[16]; // = {0x2B,0x62,0x14,0xA6,0xCE,0x43,0xAC,0x52,0x7A,0xC7,0xEE,0x13,0x80,0x0A,0xC8,0x85};
