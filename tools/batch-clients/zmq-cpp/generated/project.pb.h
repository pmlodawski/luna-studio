...
inline void Project::set_has_projectid() {
  _has_bits_[0] |= 0x00000010u;
}
inline void Project::clear_has_projectid() {
  _has_bits_[0] &= ~0x00000010u;
}
...
inline ::google::protobuf::int32 Project::projectid() const {
  return projectid_;
}
inline void Project::set_projectid(::google::protobuf::int32 value) {
  set_has_projectid();
  projectid_ = value;
}
