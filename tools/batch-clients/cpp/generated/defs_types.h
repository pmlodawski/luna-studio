...
class DefManager {
 public:
  ...
  static const char* ascii_fingerprint; // = "3AC67F88FFAB54DD8D17896DB4CB5B0D";
  static const uint8_t binary_fingerprint[16]; // = {0x3A,0xC6,0x7F,0x88,0xFF,0xAB,0x54,0xDD,0x8D,0x17,0x89,0x6D,0xB4,0xCB,0x5B,0x0D};
