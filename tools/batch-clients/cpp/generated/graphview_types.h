...
class GraphView {
 public:
  ...
  static const char* ascii_fingerprint; // = "BCB74A80C7F5B55C3F00E232E4A46BC1";
  static const uint8_t binary_fingerprint[16]; // = {0xBC,0xB7,0x4A,0x80,0xC7,0xF5,0xB5,0x5C,0x3F,0x00,0xE2,0x32,0xE4,0xA4,0x6B,0xC1};
