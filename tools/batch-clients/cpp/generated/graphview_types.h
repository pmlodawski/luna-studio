...
class GraphView {
 public:
  ...
  static const char* ascii_fingerprint; // = "EDD8DF08EAEAA925263F133255AFC4DE";
  static const uint8_t binary_fingerprint[16]; // = {0xED,0xD8,0xDF,0x08,0xEA,0xEA,0xA9,0x25,0x26,0x3F,0x13,0x32,0x55,0xAF,0xC4,0xDE};
