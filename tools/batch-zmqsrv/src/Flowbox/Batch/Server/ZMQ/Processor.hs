...
import qualified Generated.Proto.ServerApi.Server.Method      as Method
import           Generated.Proto.ServerApi.Server.Method        (Method(Method))
import qualified Generated.Proto.ServerApi.Server.Method.Name as MethodName
