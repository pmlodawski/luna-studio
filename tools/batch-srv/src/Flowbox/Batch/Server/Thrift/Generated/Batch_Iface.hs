...
class Batch_Iface a where
  ...
  nodeDefaults :: a -> Maybe Int32 -> Maybe Int32 -> Maybe Int32 -> Maybe Int32 -> IO (Map.HashMap (Vector.Vector Int32) Graph_Types.Value)
  setNodeDefault :: a -> Maybe (Vector.Vector Int32) -> Maybe Graph_Types.Value -> Maybe Int32 -> Maybe Int32 -> Maybe Int32 -> Maybe Int32 -> IO ()
