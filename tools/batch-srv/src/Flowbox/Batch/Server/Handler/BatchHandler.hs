...
instance Handler BatchHandler where
    ...
    updateDataCls        h = HAST.updateDataCls        (batchRef h)
    updateDataCons       h = HAST.updateDataCons       (batchRef h)
    updateDataClasses    h = HAST.updateDataClasses    (batchRef h)
    updateDataMethods    h = HAST.updateDataMethods    (batchRef h)
