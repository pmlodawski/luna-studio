...
sampleGraphs =
    ...
    $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "main2") "" (0, 1))
        ,(-3, Node.Outputs        (0, 2))
        ]
        []
    ...
    $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "main") "" (0, 1))
        ,(-3, Node.Outputs        (0, 2))
        ]
        []
    ...
    $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "foo") "" (0, 1))
        , fixEmpty' (200, Node.Expr (NodeExpr.Expr "bar") "" (0, 2))
        ,(-3, Node.Outputs        (0, 3))
        ]
    ...
    $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "25") "" (0, 1))
        , fixEmpty' (200, Node.Expr (NodeExpr.Expr "*") "" (0, 1))
        ,(-3, Node.Outputs        (0, 3))
        ]
    ...
    $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "1.+ 2") "" (0, 1))
        ,(-3, Node.Outputs        (0, 2))
        ]
        []
    ...
    $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "1.+ 2.* 2") "" (0, 1))
        ,(-3, Node.Outputs        (0, 2))
        ]
        []
    ...
    $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "a.foo bar 1 \"asda\"") "" (0, 1))
        ,(-3, Node.Outputs        (0, 2))
        ]
        []
     ...
     $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "a.foo bar baz (gaz 1 \"asda\")") "" (0, 1))
        ,(-3, Node.Outputs        (0, 2))
        ]
        []
     , named "BATCH-62"
     $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (100, Node.Expr (NodeExpr.Expr "12") "" (0, 1))
        ,(-3, Node.Outputs        (0, 2))
        ]
     ...
     $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2, Node.Inputs         (0, 0))
        , fixEmpty' (10, Node.Expr (NodeExpr.Expr "12") "" (0, 1))
        , fixEmpty' (20, Node.Expr (NodeExpr.Expr "15") "" (0, 1))
        , fixEmpty' (30, Node.Expr (NodeExpr.Expr "*") "" (0, 1))
        , fixEmpty' (40, Node.Expr (NodeExpr.Expr "+") "" (0, 1))
        ,(-3, Node.Outputs        (0, 2))
        ]
     ...
     $ Graph.addMonadicEdges $ Graph.mkGraph
        [(-2,Node.Inputs  (0 ,0))
        ,(-3,Node.Outputs (10,0))
        ,fixEmpty' (100, Node.Expr (NodeExpr.Expr "255") "" (0 , 1))
        ]
        [(100, -3, Edge.Data Port.All $ Port.Num 0)]
    ]
