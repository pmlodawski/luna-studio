...
--          p pt = rotateCenter (handle pt) pt
...
colorCorrectLuna' ( VPS (fmap variable -> ColorD masterSaturationR masterSaturationG masterSaturationB masterSaturationA)
    ...
    where curveShadows    = A.lift $ CubicBezier (Point2 (0::Double) 1) (Point2 0.03 1) (Point2 0.06 0) (Point2 0.09 0) :: Exp (CubicBezier Double)
          ...
          correct master shadows midtones highlights x = let
              ...
              in master x + (master $ coeffShadows * shadows x + coeffMidtones * midtones x + coeffHighlights * highlights x) -- master x -- + coeffShadows * shadows x + coeffMidtones * midtones x + coeffHighlights * highlights x
          ...
          saturateOnHSV masterSat shadowsSat midtonesSat highlightsSat pix =
              Color.toHSV pix & (\(Color.HSV h s v) -> let
                  ...
                  in Color.HSV h (s * masterSat) v) & Color.toRGB
