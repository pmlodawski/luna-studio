...
replaceExpr conv (Label l1 expr) = Label (conv l1) $ case expr of
    ...
    Expr.Assignment  dst src            -> Expr.Assignment (replacePat conv dst) (replaceExpr conv src)
...
replaceSegment = undefined
replaceArg = undefined
replaceFuncOutput = undefined
replaceFieldUpd = undefined
replaceExprArg = undefined
replacePat = undefined
replaceMatch = undefined
replaceLit = undefined
replaceList = undefined
replaceNative = undefined
replaceNamePat = undefined
