...
distPath     = "dist"
sboxRootPath = os.path.join(distPath, 'sboxRoot')
...
def main():
    ...
    platformFix(distPath)

    ### check if cabal is available in the system in the proper version
    assertInstall("cabal")
    ...
    checkCabalPkg("c2hs", installUsing=install_alex_happy, version="0.17.2")
