...
corePkgDb = \
       { 'libs/batch/batch'                    : HProject   ('flowbox-batch'                , os.path.join ('libs' , 'batch', 'batch')                      , 'libs'    , ['libs/utils', 'libs/config', 'libs/luna/core', 'libs/luna/distribution-old', 'libs/luna/initializer', 'libs/luna/pass-old', 'libs/luna/protobuf-old'])
...
pkgDb = dict(corePkgDb, **{
       ...
       , 'libs/luna/distribution-old'          : HProject   ('luna-distribution-old'        , os.path.join ('libs' , 'luna', 'distribution-old')            , 'libs'    , ['libs/utils', 'libs/config', 'libs/luna/core'])
       , 'libs/luna/interpreter'               : HProject   ('luna-interpreter'             , os.path.join ('libs' , 'luna', 'interpreter')                 , 'libs'    , ['libs/utils', 'libs/luna/core', 'libs/luna/pass-old', 'libs/batch/batch', 'libs/data/serialization', 'libs/luna/distribution-old'])
       ...
       , 'libs/luna/pass'                      : HProject   ('luna-pass'                    , os.path.join ('libs' , 'luna', 'pass')                        , 'libs'    , ['libs/utils', 'libs/luna/core', 'libs/config', 'libs/luna/target/ghchs'])
       , 'libs/luna/pass-old'                  : HProject   ('luna-pass-old'                , os.path.join ('libs' , 'luna', 'pass-old')                    , 'libs'    , ['libs/utils', 'libs/luna/core', 'libs/config', 'libs/luna/target/ghchs', 'libs/luna/parser2-old', 'libs/luna/distribution-old'])
       , 'libs/luna/parser2-old'               : HProject   ('luna-parser2-old'             , os.path.join ('libs' , 'luna', 'parser2-old')                 , 'libs'    , ['libs/utils', 'libs/luna/core'])
       , 'libs/luna/protobuf'                  : HProject   ('luna-protobuf'                , os.path.join ('libs' , 'luna', 'protobuf')                    , 'libs'    , ['libs/utils', 'libs/luna/core', 'libs/config', 'libs/luna/distribution'])
       , 'libs/luna/protobuf-old'              : HProject   ('luna-protobuf-old'            , os.path.join ('libs' , 'luna', 'protobuf-old')                , 'libs'    , ['libs/utils', 'libs/luna/core', 'libs/config', 'libs/luna/distribution-old'])
       ...
       , 'tools/batch/plugins/file-manager'    : HProject   ('batch-plugin-file-manager'    , os.path.join ('tools', 'batch', 'plugins', 'file-manager')    , 'tools'   , ['libs/utils', 'libs/config', 'libs/rpc', 'libs/bus', 'libs/batch/plugins/file-manager'])
       ...
       , 'tools/batch/plugins/s3-file-manager' : HProject   ('batch-plugin-s3-file-manager' , os.path.join ('tools', 'batch', 'plugins', 's3-file-manager') , 'tools'   , ['libs/utils', 'libs/config', 'libs/rpc', 'libs/bus', 'libs/luna/core', 'libs/batch/batch', 'libs/aws', 'libs/batch/plugins/file-manager'])
