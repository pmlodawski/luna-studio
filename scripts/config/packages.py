...
pkgDb = PathDict(
       ...
       , 'libs/batch'                          : HProject   ('flowbox-batch'                , os.path.join ('libs' , 'batch')                               , 'libs'    , ['libs/utils', 'libs/config', 'tools/initializer', 'libs/luna/base'])
       ...
       , 'tools/interpreter'                   : HProject   ('flowbox-interpreter'          , os.path.join ('tools', 'interpreter')                         , 'tools'   , ['libs/utils', 'libs/config', 'libs/rpc', 'libs/bus', 'libs/luna', 'libs/batch'])
       , 'tools/lunac'                         : HProject   ('flowbox-lunac'                , os.path.join ('tools', 'lunac')                               , 'tools'   , ['libs/utils', 'libs/config', 'tools/initializer', 'libs/luna/base'], ['--force-reinstalls']) # FIXME [PM] force reinstalls-flag  resolves problem with HTTP and network
