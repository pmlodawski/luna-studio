...
pkgDb = \
       ...
       , 'libs/luna/typechecker'               : HProject   ('luna-typechecker'             , os.path.join ('libs' , 'luna', 'typechecker')                 , 'libs'    , ['libs/luna/core'])  # [szaman] flags=Flags([Flag('--force-reinstalls')]) ?????
