...
pkgDb = \
       ...
       , 'tools/batch/plugins/interpreter'     : HProject   ('flowbox-interpreter'          , os.path.join ('tools', 'batch', 'plugins', 'interpreter')     , 'tools'   , ['libs/utils', 'libs/config', 'libs/rpc', 'libs/bus', 'libs/luna/base', 'libs/luna/interpreter', 'libs/batch/plugins/project-manager'])
