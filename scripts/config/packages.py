...
pkgDb = dict(corePkgDb, **{
       ...
       , 'libs/batch/plugins/project-manager'  : HProject   ('batch-lib-project-manager'    , os.path.join ('libs' , 'batch', 'plugins', 'project-manager') , 'libs'    , ['libs/batch/batch', 'libs/batch/plugins/project-manager-api', 'libs/bus', 'libs/config', 'libs/luna/core', 'libs/rpc', 'libs/utils', 'tools/batch/plugins/ur-manager'])
