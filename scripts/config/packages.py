...
pkgDb = dict(corePkgDb, **{
       ...
       , 'libs/batch/plugins/project-manager'  : HProject   ('batch-lib-project-manager'    , os.path.join ('libs' , 'batch', 'plugins', 'project-manager') , 'libs'    , ['libs/batch/batch', 'libs/batch/plugins/project-manager-api', 'libs/bus', 'libs/config', 'libs/luna/core', 'libs/rpc', 'libs/utils', 'libs/batch/plugins/ur-manager'])
       , 'libs/batch/plugins/project-manager-api': HProject('batch-lib-project-manager-api', os.path.join ('libs' , 'batch', 'plugins', 'project-manager-api') , 'libs' , ['libs/batch/batch', 'libs/luna/protobuf-old'])
       ...
       , 'libs/batch/plugins/ur-manager'       : HProject   ('batch-lib-ur-manager'         , os.path.join ('libs' , 'batch', 'plugins', 'ur-manager')      , 'libs'    , ['libs/bus'])
       ...
       , 'libs/luna/interpreter-runtime'       : HProject   ('luna-interpreter-runtime'     , os.path.join ('libs' , 'luna', 'interpreter-runtime')         , 'libs'    , ['libs/data/serialization', 'libs/luna/target/ghchs', 'libs/utils', 'third-party/HMap'])
       ...
       , 'tools/batch/plugins/ur-manager'      : HProject   ('batch-plugin-ur-manager'      , os.path.join ('tools', 'batch', 'plugins', 'ur-manager')      , 'tools'   , ['libs/config', 'libs/rpc', 'libs/bus', 'libs/batch/batch', 'libs/batch/plugins/ur-manager'])
