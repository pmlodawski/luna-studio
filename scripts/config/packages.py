...
pkgDb = PathDict(
       ...
       , 'tools/batch/plugins/text2ast'        : HProject   ('flowbox-text2ast'             , os.path.join ('tools' , 'batch', 'plugins', 'text2ast')        , 'tools'   , ['libs/utils', 'libs/config', 'libs/rpc', 'libs/bus', 'libs/luna', 'libs/batch'])
