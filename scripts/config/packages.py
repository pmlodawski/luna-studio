...
pkgDb = \
       ...
       , 'third-party/accelerate-fft'          : HProject   ('accelerate-fft'               , os.path.join ('third-party', 'accelerate-fft')                , 'third-party', [], flags=Flags([Flag('-fdebug')]))
