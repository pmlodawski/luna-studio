...
pkgDb = \
       ...
       , 'libs/luna/typechecker'               : HProject   ('luna-typechecker'             , os.path.join ('libs' , 'luna', 'typechecker')                 , 'libs'    , ['libs/luna/base'], flags=Flags([Flag('--force-reinstalls')])) # FIXME [PM, copied by KG] force reinstalls-flag  resolves problem with HTTP and network
