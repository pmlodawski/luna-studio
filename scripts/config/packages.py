...
pkgDb = \
       ...
       , 'libs/luna/interpreter'               : HProject   ('flowbox-luna-interpreter'     , os.path.join ('libs' , 'luna', 'interpreter')                 , 'libs'    , ['libs/utils', 'libs/luna/base'], ['--force-reinstalls']) # FIXME [PM] force reinstalls-flag  resolves problem with HTTP and network
