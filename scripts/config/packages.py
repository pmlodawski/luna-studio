...
pkgDb = PathDict(
       ...
       , 'tools/lunac'                         : HProject   ('flowbox-lunac'                , os.path.join ('tools' , 'lunac')                               , 'tools'   , ['libs/utils', 'libs/config', 'tools/initializer', 'libs/luna'], ['--force-reinstalls']) # FIXME [PM] force reinstalls-flag  resolves problem with HTTP and network
