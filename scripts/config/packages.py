...
corePkgDb = \
       ...
       , 'libs/luna/typechecker'               : HProject   ('luna-typechecker'             , os.path.join ('libs' , 'luna', 'typechecker')                 , 'libs'    , ['libs/logger', 'libs/luna/core', 'libs/luna/parser3'])
...
pkgDb = dict(corePkgDb, **{
       ...
       , 'libs/luna/pass2'                     : HProject   ('luna-pass'                    , os.path.join ('libs' , 'luna', 'pass2')                       , 'libs'    , ['libs/utils', 'libs/luna/core', 'libs/luna/distribution', 'libs/config', 'libs/luna/target/ghchs', 'libs/luna/parser3'])
