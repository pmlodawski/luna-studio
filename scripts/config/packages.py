...
pkgDb = \
       ...
       , 'libs/batch/plugins/project-manager'  : HProject   ('flowbox-project-manager'      , os.path.join ('libs' , 'batch', 'plugins', 'project-manager') , 'libs'    , ['libs/utils', 'libs/config', 'libs/rpc', 'libs/bus', 'libs/luna/core', 'libs/batch/batch'])
       ...
       , 'tools/batch/plugins/interpreter'     : HProject   ('flowbox-interpreter'          , os.path.join ('tools', 'batch', 'plugins', 'interpreter')     , 'tools'   , ['libs/utils', 'libs/config', 'libs/rpc', 'libs/bus', 'libs/luna/interpreter', 'libs/luna/interpreter', 'libs/batch/batch', 'libs/batch/plugins/project-manager'])
