...
startConnecting :: Position -> Timestamp -> Command State ()
startConnecting pos timestamp = unlessM inTopLevelBreadcrumb $ do
...
connectMove :: Position -> Timestamp -> PenConnect -> Command State ()
connectMove pos timestamp state = do
