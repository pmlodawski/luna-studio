...
main = do
    ...
    let graph = Graph.mkGraph
                    [ (0, Node "15"    $ Type "Int" Type.Pure)
                    , (1, Node "12"    $ Type "Int" Type.Pure)
                    , (2, Node "94"    $ Type "Int" Type.Pure)
                    , (3, Node "(+)"   $ Type "Int -> Int -> Int" Type.Pure)
                    , (4, Node "(*)"   $ Type "Int -> Int -> Int" Type.Pure)
                    , (5, Node "print" $ Type "Int -> IO ()" Type.IO)
                    ]
