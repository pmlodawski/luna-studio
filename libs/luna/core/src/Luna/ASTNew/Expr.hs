...
import           Luna.ASTNew.Name.Pattern2 (NamePat)
...
data Expr a v
    ...
    | App2        (NamePat (LExpr a v) (AppArg (LExpr a v)))
...
--data App arg e = Prefix   (Segment e arg)
--               | Infix    arg Var arg [arg]
--               | Postfix  arg Var
--               | MultiApp (Maybe arg) (Segment Var arg) (Segment String arg) [Segment String arg]
--               deriving (Show, Eq, Generic, Read)

--data AppArg e = AppArg (Maybe ArgName) e

--data Segment base arg = Segment base [arg]

--type ExprApp = App (AppArg e) e
