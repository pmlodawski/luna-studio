...
instance  (LiftErr' base1 (UnsafeBase Safe e2) dstBase, LiftErr' (UnsafeBase dstBase e1) base2 out, Functor dstBase, LiftErr' dstBase Safe dstBase, Functor base1, Monad base1) =>LiftErr' (UnsafeBase base1 e1) (UnsafeBase base2 e2) out   where
    liftErr' (sf :: UnsafeBase base1 e1 (a->b)) (sa :: UnsafeBase base2 e2 a) = case sa of
