...
instance LiftErr' (UnsafeBase base1 e1) (UnsafeBase base2 e2) out  <= (LiftErr' base1 (UnsafeBase Safe e2) dstBase, LiftErr' (UnsafeBase dstBase e1) base2 out, Functor dstBase, LiftErr' dstBase Safe dstBase, Functor base1, Monad base1) where
    liftErr' (sf :: UnsafeBase base1 e1 (a->b)) (sa :: UnsafeBase base2 e2 a) = case sa of
        Value a -> liftErr' (fmap const $ liftErrxxx sf (Value a :: UnsafeBase Safe e2 a)) (undefined :: base2 a)
        Error e -> liftErr' (fmap const $ liftErrxxx sf (Error e :: UnsafeBase Safe e2 a)) (undefined :: base2 a)
        Other o -> liftErr' (liftErrxxx (fmap const sf) (undefined :: UnsafeBase Safe e2 a)) (o :: base2 a)
        --Value a -> liftErr' (fmap const $ liftErr' sf (Value a :: UnsafeBase Safe e2 a)) (undefined :: base2 a)
        --Error e -> liftErr' (fmap const $ liftErr' sf (Error e :: UnsafeBase Safe e2 a)) (undefined :: base2 a)
        --Other o -> liftErr' (liftErr' (fmap const sf) (undefined :: UnsafeBase Safe e2 a)) (o :: base2 a)
...
--data Func2 out = forall t1 t2. Func2 (t1 -> t2 -> out) t1 t2

--data Test func out = Test { name :: String
--                          , func :: func
--                          , out  :: out
--                          } deriving (Show, Typeable, Eq)

--runTest tst = it (name tst) $ (runFunc (func tst)) `shouldBe` (out tst)

--class RunFunc f out | f -> out where
--    runFunc :: f -> out

--instance RunFunc (Func2 out) out where
--    runFunc (Func2 f a b) = f b a

----runFunc (Func2 f a b) = f a b

--mkTest name func out = runTest $ Test name func out
...
v1x12 = Other $ Value 1 :: UnsafeBase (UnsafeBase Safe E2) E1 Int
v1x13 = Other $ Value 1 :: UnsafeBase (UnsafeBase Safe E3) E1 Int

v2x21 = Other $ Value 1 :: UnsafeBase (UnsafeBase Safe E1) E2 Int
v2x31 = Other $ Value 1 :: UnsafeBase (UnsafeBase Safe E1) E3 Int
