...
sig = (arg::Arg "x" Unprovided,(arg::Arg "y" Unprovided,(defArg 5::Num a=>Arg "z" (Provided a),())))
...
type family ExtractNames t :: [Symbol] where
    ExtractNames () = '[]
...
main = do
    ...
    let f = mkFunc sig -- (Unprovided,(Unprovided,(Provided 5,()))) :: Num a => FuncTrans ["x","y","z"] (Unprovided,(Unprovided,(Provided a,()))) f f
