...
--alibManager = LibManager.insNode (0, Library "std"           $ UniPath.fromUnixString "lunalib/stdlib")
--            $ LibManager.insNode (1, Library "__workspace__" $ UniPath.fromUnixString "lunalib/Core") 
--            $ LibManager.empty
...
--core :: Core
--core = Core.empty{ libManager = alibManager 
--                 , defManager = adefManager
--                 }