...
module Flowbox.Luna.Passes.CodeGen.Cabal.CabalConfig where

import qualified Data.List                                     as List

import           Flowbox.Prelude                                 
import qualified Flowbox.Luna.Passes.CodeGen.Cabal.CabalModule as CabalModule
import           Flowbox.Luna.Passes.CodeGen.Cabal.CabalModule   (CabalModule)
import qualified Flowbox.Luna.Passes.CodeGen.Cabal.Section     as Section
import           Flowbox.Luna.Passes.CodeGen.Cabal.Section       (Section(Section))
