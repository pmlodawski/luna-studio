...
import           Luna.Syntax.Model.Layer                 (Type, Succs, Markable, Redirect, Replacement, Meta, Name, Lambda, (:<:), (:<))
...
type NetLayers     a  = '[Type, Succs, Redirect, Replacement, Interpreter, Meta a]
