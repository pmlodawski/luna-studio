...
import Luna.Typechecker.TypeEnv      (TypeEnv)
...
instance Inference Lit where
  infer _ _ = err "notimplemented" "sorry, Inference for Lit is not yet implemented"
...
instance Inference (Expr f a) where
  infer _ _ = err "notimplemented" "sorry, Inference for Expr is not yet implemented"
