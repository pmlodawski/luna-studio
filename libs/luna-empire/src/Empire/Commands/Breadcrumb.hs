...
makeGraphCls fun lastUUID = error "makeGraphCls" -- do
    ...
    --     putLayer @Marker fun $ Just $ OutPortRef (NodeLoc def uuid) []
...
withRootedFunction uuid act = error "withRootedFunction" -- do
