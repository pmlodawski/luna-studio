...
import qualified Parser.Data.Invalid      as Attr
import qualified Parser.Data.Name.Spaced  as Name
import qualified Parser.Data.Name.Special as SpecialName
import qualified Parser.IR.Expr           as Expr
import qualified Parser.Loc               as Loc
import qualified Parser.State.Indent      as Indent
import qualified Parser.State.Marker      as Marker
import qualified Parser.State.Reserved    as Reserved
...
import Parser.Data.CodeSpan    (CodeSpan (CodeSpan),
                                                 CodeSpanRange (..))
import Parser.Data.Name.Spaced (SpacedName)
import Parser.IR.Class         (Parser, Stream, Token)
import Parser.Loc              (checkNextOffset,
                                                 previewNextSymbol, token')
import Parser.Pass.Class       (IRB, IRBS (IRBS), fromIRBS,
                                                 liftIRBS1, liftIRBS2,
                                                 liftIRBS3)
import Parser.State.LastOffset (LastOffset (LastOffset))
