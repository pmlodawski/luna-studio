...
multisamplerTest = do
    ...
    let weightFun tickPos val1 weight1 val2 weight2 = mix tickPos val1 val2
    let mapper = flip colorMapper weightFun
    let grad8     = rasterizer (Grid 720 480) $ mysampler $ translate (V2 (720/2) (480/2)) $ rotate (84 * pi / 180) $ mapper gray conicalShape
...
scalingTest flt = do
    ...
    let process x = rasterizer (Grid 720 480) $ monosampler 
