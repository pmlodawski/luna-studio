...
module Flowbox.Graphics.Composition.Color where
...
import           Flowbox.Graphics.Composition.Internal (Premultiply(..), Mask(..), Clamp)
import qualified Flowbox.Graphics.Composition.Internal as Comp
