{-# LINE 1 "src/OpenCV/FloodFill.hsc" #-}
{-# LANGUAGE ForeignFunctionInterface, TypeFamilies #-}
{-# LINE 2 "src/OpenCV/FloodFill.hsc" #-}
...
{-# LINE 20 "src/OpenCV/FloodFill.hsc" #-}
...
{-# LINE 32 "src/OpenCV/FloodFill.hsc" #-}
...
floodHelper (x,y) newVal loDiff upDiff range src =
  ...
  withS upDiff $ \upDiffPtr ->
    ...
    where flags = case range of
                    FloodFixed -> 4 .|. 65536
{-# LINE 53 "src/OpenCV/FloodFill.hsc" #-}
                    FloodFloating -> 4
