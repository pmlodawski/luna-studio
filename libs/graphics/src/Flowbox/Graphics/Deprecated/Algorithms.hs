...
applyToImage :: (Channel2 a -> Channel2 a) -> String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
lutImage :: (A.Elt a, A.IsFloating a) => String3 -> [(Exp a, Exp a)] -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
binarizeImage :: (A.Elt a, A.IsNum a) => (Exp a -> Exp Bool) -> String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
binarizeImage f = applyToImage (binarizeChannel f)

luminance :: (A.Elt a, A.IsFloating a) => String3 -> String -> (Image (RawData2 a)) -> Either Image.Error (Image (RawData2 a))
...
luminance' :: (A.Elt a, A.IsFloating a) => (Image (RawData2 a)) -> Either Image.Error (Image (RawData2 a))
...
erodeImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
dilateImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
dilateImage = applyToImage dilateChannel



openImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
openImage names img = do
    imgA <- erodeImage names img
    imgB <- dilateImage names imgA
    return imgB

closeImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
medianImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
medianImage = applyToImage medianChannel



premultiply :: (A.Elt a, A.IsFloating a) => Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
premultiply img = do
...
unpremultiply :: (A.Elt a, A.IsFloating a) => Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
convolve :: (A.Elt a, A.IsFloating a, A.Stencil A.DIM2 a stencil) =>
  String3 -> (t -> stencil -> Exp a) -> t -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
convolveRGB :: (A.Elt a, A.IsFloating a, A.Stencil A.DIM2 a stencil) =>
  (t -> stencil -> Exp a) -> t -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
--adjustCB_RGB :: (A.Elt a, A.IsFloating a) => Exp a -> Exp a -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
--adjustCB_RGB = adjustCB ("rgba.r", "rgba.g", "rgba.b")

adjustCB :: (A.Elt a, A.IsFloating a) => String3 -> Exp a -> Exp a -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
contrast :: (A.Elt a, A.IsFloating a) => Exp a -> String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
contrast x rgb = adjustCB rgb x 0

brightness :: (A.Elt a, A.IsFloating a) => Exp a -> String3 -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
convertRGBtoHSV :: (A.Elt a, A.IsFloating a) => Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
convertHSVtoRGB :: (A.Elt a, A.IsFloating a) => Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
blendAlpha :: (A.Elt a, A.IsFloating a) => Image (RawData2 a) -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
blendAlpha img1 img2 = do
    a2 <- Image.get "rgba.a" img2
    outimg <- blendAlpha' img1 img2 a2
    return outimg

blendAlpha' :: (A.Elt a, A.IsFloating a) => Image (RawData2 a) -> Image (RawData2 a) -> Channel2 a -> Either Image.Error (Image (RawData2 a))
...
keyColor :: (A.Elt a, A.IsFloating a) => String3 -> Exp3 a -> Exp3 a
            -> (Exp a -> Exp a) -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
...
extractBackground :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData3 a) -> Either Image.Error (Image (RawData2 a))
...
cutOut :: (A.Elt a, A.IsFloating a) => String3 -> Exp3 a -> (Exp a -> Exp a)
          -> Image (RawData2 a) -> Image (RawData2 a) -> Either Image.Error (Image (RawData2 a))
