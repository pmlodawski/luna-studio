...
lutImage :: (A.Elt a, A.IsFloating a) => String3 -> [(Exp a, Exp a)] -> Image (RawData2D a) -> Either Image.Error (Image (RawData2D a))
...
erodeImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2D a) -> Either Image.Error (Image (RawData2D a))
...
dilateImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2D a) -> Either Image.Error (Image (RawData2D a))
dilateImage = applyToImage dilateChannel



openImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2D a) -> Either Image.Error (Image (RawData2D a))
openImage names img = do
    imgA <- erodeImage names img
    imgB <- dilateImage names imgA
    return imgB

closeImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2D a) -> Either Image.Error (Image (RawData2D a))
...
medianImage :: (A.Elt a, A.IsFloating a) => String3 -> Image (RawData2D a) -> Either Image.Error (Image (RawData2D a))
