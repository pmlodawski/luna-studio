...
--     print $ summe' v2x2 e12
    hspec $ do
        ...
        describe "LiftErr testing" $ do
            ...
            describe "[instance] LiftErr (UnsafeBase base1 e1) (UnsafeBase base2 e2) (UnsafeBase dstBase e1)" $ do
                it "sum e23 e34"     $ summe' e23 e34                  `shouldBeT` (Error E2 :: UnsafeBase (UnsafeBase (UnsafeBase Safe E4) E3) E2 Int)
                ...
                it "sum v12 v4x1234" $ summe' v12 v4x1234              `shouldBeT` (Other . Other . Other $ (Value 2) :: UnsafeBase (UnsafeBase (UnsafeBase (UnsafeBase Safe E4) E3) E2) E1 Int)
    ...
    --printTyped $ summe' e12 e1234
    --printTyped $ summe' v12 v4x1234
    --printTyped $ summe' e12 e13
...
v1x1234 = Value 1 :: UnsafeBase (UnsafeBase (UnsafeBase (UnsafeBase Safe E4) E3 ) E2) E1 Int
v2x1234 = Other (Value 1) :: UnsafeBase (UnsafeBase (UnsafeBase (UnsafeBase Safe E4) E3 ) E2) E1 Int
v3x1234 = Other . Other $ (Value 1) :: UnsafeBase (UnsafeBase (UnsafeBase (UnsafeBase Safe E4) E3 ) E2) E1 Int
v4x1234 = Other . Other . Other $ (Value 1) :: UnsafeBase (UnsafeBase (UnsafeBase (UnsafeBase Safe E4) E3 ) E2) E1 Int
