...
handlerMap callback = HandlerMap.fromList
    ...
    , (Topic.projectOpenRequest                                     , cleanCall (/+ Topic.update) ProjectHandler.open $ Just Topic.urmClearStackRequest)
    , (u Topic.projectOpenRequest                                   , cleanCall (/* Topic.update) ProjectHandler.open $ Just Topic.urmClearStackRequest)
