...
def ghcjs_code_atomless():
    ...
    shutil.copy(node_editor_js[0], prep_path("../app/src/gen/node-editor.js"))
    shutil.copy(text_editor_js[0], prep_path("../app/src/gen/text-editor.js"))
