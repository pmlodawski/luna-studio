...
-- setUniform m a v = JSObject.setProp (JSString.pack $ uniformName a) (toJSVal $ unUniform v) (unUniformMap m)
--
--
-- buildUniform :: Text -> JSRef a -> IO Uniform
-- buildUniform t v = do
--     o <- JSObject.create
--     let x = toJSVal $ lazyTextToJSString t
