...
var colors = [
    ...
    new THREE.Vector4(0xFF, 0x00, 0xFF, 0xFF).divideScalar(0xFF), // black 1
    ...
    new THREE.Vector4(0x50, 0x90, 0xC0, 0xFF).divideScalar(0xFF), // bluish 11
    new THREE.Vector4(0xB0, 0x40, 0x24, 0xFF).divideScalar(0xFF), // reddish 12
    new THREE.Vector4(0xD0, 0xB0, 0x50, 0xFF).divideScalar(0xFF), // reddish2 13
    new THREE.Vector4(0xFF, 0x00, 0x00, 0xFF).divideScalar(0xFF), // red 14
    new THREE.Vector4(0xB0, 0x70, 0x40, 0xFF).divideScalar(0xFF), // reddish3 15
    new THREE.Vector4(0x40, 0x60, 0xB0, 0xFF).divideScalar(0xFF), // bluish 16
